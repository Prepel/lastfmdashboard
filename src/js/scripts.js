...
function getRecentTrackPerUser() {
    users.forEach(function (username) {
        lastfm.user.getRecentTracks({user: username, limit: 1, extended: 1}, {
...
function getLast10TracksPerUser() {
    users.forEach(function (username) {
        lastfm.user.getRecentTracks({user: username, limit: 5, extended: 1}, {
            success: function (data) {
...
function loadUser(username) {
    lastfm.user.getInfo({user: username}, {
        success: function (data) {
